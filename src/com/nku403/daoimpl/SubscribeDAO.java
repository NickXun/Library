...
/**
 	* A data access object (DAO) providing persistence and search support for Subscribe entities.
...
public class SubscribeDAO extends HibernateDaoSupport  {
	     private static final Logger log = LoggerFactory.getLogger(SubscribeDAO.class);
		//property constants
    ...
    public Subscribe findById( com.nku403.entity.SubscribeId id) {
        ...
        try {
            Subscribe instance = (Subscribe) getHibernateTemplate()
                    .get("com.nku403.entity.Subscribe", id);
            return instance;
        } catch (RuntimeException re) {
    ...
    public Subscribe merge(Subscribe detachedInstance) {
        ...
        try {
            Subscribe result = (Subscribe) getHibernateTemplate()
