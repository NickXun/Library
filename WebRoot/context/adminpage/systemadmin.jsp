...
header {
				...
				<div class="col-sm-2">
					<div class="list-group">
						<a href="#" class="list-group-item active"> <span
							class="glyphicon glyphicon-home"></span> &nbsp;图书管理员管理 </a>
						<a href="#" class="list-group-item"> <span
							class="glyphicon glyphicon-home"></span> &nbsp;部门管理 </a>
					</div>
				</div>
					...
					<div class="panel-group" id="accordion" role="tablist"
							...
							<div class="panel-heading" role="tab" id="headingOne">
								<h4 class="panel-title">
									<a role="button" data-toggle="collapse"
										...
										aria-expanded="true" aria-controls="collapseOne"> 添加图书管理员
									</a>
								</h4>
							</div>
								...
								<div class="panel-body">
									<form action="insertUser" method="post">
										...
										<div class="form-group">
											...
											<input type="text" class="form-control" id="password" placeholder="password" name="userPassword">
										</div>
						...
						<div class="panel panel-primary">
							...
							<div id="collapseTwo" class="panel-collapse collapse"
								...
								<div class="panel-body">
									<s:action name="system" executeResult="false"></s:action>
									<table class="table table-hover">
										...
										<s:iterator id="adminList" value="#request.libAdmin">
										<tr><td>${adminList.getUserId()}</td><td>${adminList.getUserName()}</td><td><a href="deleteUser?userId=${adminList.getUserId()}"><span class="glyphicon glyphicon-remove"></span></a></td></tr>
										</s:iterator>
									</table>
								</div>
							</div>
    ...
    ================================================== -->
			...
			<script>
				...
				function alertDel(){
					<% 
						if(request.getAttribute("delsuccess") == "success"){
						%>
							alert("删除成功");
						<%
						}
